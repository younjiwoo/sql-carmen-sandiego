...
SELECT name, population FROM countries WHERE continent = 'Europe' ORDER BY population ASC LIMIT 1;
-- name              | population
-- -------------------------------+------------
...
SELECT name, countrycode FROM cities WHERE name LIKE 'Ser%';
--  name      | countrycode
-- ----------------+-------------
-- Serra          | BRA
...
-- Clue #6: We're close! Our South American agent says she just got a taxi at the airport, and is headed towards
 ...
 SELECT name, id FROM cities WHERE id=211;
 --     name    | id
 -- ------------+-----
 --  Bras�lia | 211
 -- (1 row)
